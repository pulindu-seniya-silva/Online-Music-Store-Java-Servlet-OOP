...
<t:mainLayout title="Page Title">
    ...
    <jsp:attribute name="content">
        <div class="flex align-middle justify-between">
            <h1 class="text-3xl font-bold">Products (${productList.size()})</h1>
            <button onclick="return openModal();" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2">Create</button>
        </div>
            ...
            <table class="w-full text-sm text-left text-gray-500">
                ...
                <tbody>
                    <c:forEach var="product" items="${productList}">
                        <tr onclick="navigate('/music_store/admin/item-view?id=${product.id}')" class="bg-white border-b cursor-pointer">
                            <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">${product.name}</th>
                            <td class="px-6 py-4">${product.colour}</td>
