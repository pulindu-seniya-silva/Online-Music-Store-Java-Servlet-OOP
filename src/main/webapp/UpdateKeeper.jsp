...
<div class="body-1">
            <div class="container">
                    <form action = "stk/update" method = "post">
                     <p style="border: 2px solid white; background-color: #333; color:white; padding: 10px; margin-top: -20px; position: center; text-align:center; border-radius: 8px; font-size: 20px">Updating Your Account</p>
                       <input type="hidden" name="id" value="<%= id %>">
                        <div class="user-details">
                            <div class="input-box">
                                <span class="details">User Name</span>
                                <input rtype="text" name = "username" value="<%= username%>">
                            </div>
                            <div class="input-box">
                            ...
                            <div class="input-box"><br>
                                ...
                                <input type="text"  name = "available_Instrument_Types" value= "<%= available_Instrument_Types%>"required>
                           </div>
                           <div class="input-box"><br>
                            ...
                            <div class="input-box"><br>
                                ...
                                <input type="text"  name = "available_Music_Brands" value= "<%= available_Music_Brands %>" required>
                            </div>
                            <div class="input-box"><br>
                            ...
                            <div class="input-box"><br>
                                ...
                                <input type="text"  name = "available_time" value= "<%= available_time%>"  required>
                            </div>
                            <div class="input-box"><br>
                                <span class="details">Feedback Ratings</span>
                                <input type="text" readonly name = "feedback" value= "4.1">
                            </div>   
                            <div style="text-align: center; width: 100%">
                            <input type = "submit" name ="submit" value = "Update My Data" style="background-color: #4CAF50; color: white; border: none; padding: 12px 24px; font-size: 16px; border-radius: 8px; cursor: pointer; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2); text-align: center;">      
                      		</div>
                        </div>
                     </div>
                    </form>
